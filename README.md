...
> Developed and tested on macOS only. Contributions for Windows are welcome. Linux users: I recommend [niri](https://github.com/YaLTeR/niri), the scrolling window manager that inspired gwae.
...
<kbd>⌥</kbd> + <kbd>/</kbd> opens the cheat sheet (Option).
