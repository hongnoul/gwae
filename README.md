...
tmux remains the right tool for persistent remote sessions. herdr is a solid alternative if you want workspaces and tabs over an infinite strip. Benchmarks methodology is in [Benchmark](#benchmark).
